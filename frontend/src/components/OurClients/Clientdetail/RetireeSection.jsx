...
import { CustomLink, Heading1, Heading3, Heading4, RichParagraph } from "../../Common/Common";
    ...
    <section className="bbv-section-navy relative py-20">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <Heading1 variant="section" text="Retiree-Friendly Campervans" className=" text-secondary uppercase mb-4" />

          <RichParagraph variant="body" className="text-secondary/70 font-bold">
            Creating lasting memories with comfort and freedom
          </RichParagraph>
        </div>

        <div className="max-w-3xl mx-auto text-center mb-16">
          <RichParagraph variant="body" className="italic text-secondary/80">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-20">
          {[
            ...
            <div key={i} className="flex items-center gap-4 bbv-glass-light p-5 rounded-lg border border-hover/20">
              ...
              <RichParagraph variant="card" className="font-bold uppercase t text-secondary/80">
                {item.text}
              </RichParagraph>
            </div>
          ))}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 relative z-10">
            <div className="lg:col-span-7">
              ...
              <div className="mt-8 bbv-glass-light backdrop-blur-md p-8 rounded-lg border-l-4 border-hover">
                <RichParagraph variant="card" className="text-secondary/80 italic mb-4">
                ...
                <RichParagraph variant="card" className="text-hover font-bold text-sm uppercase tracking-widest">
                  — Client from Vermont
                </RichParagraph>
              </div>
            </div>
...
Featured Build
              ...
              <Heading1 variant="section" text="Vermont Campervan" className=" text-secondary uppercase  mb-6" />
              <RichParagraph variant="body" className="text-secondary/80 mb-10">
              ...
              <div className="space-y-10">
                <div>
                  <Heading1 variant="card" text="Client Vision" className="text-secondary/60 uppercase mb-4" />
                ...
                <div className="pt-8 border-t border-hover/20">
                  <Heading1 variant="card" text="Our Delivery" className="text-secondary/60 font-black uppercase text-xs tracking-[0.2em] mb-6" />
                  <div className="space-y-6">
                    <div className="flex gap-4">
                      <Zap className="text-hover shrink-0" size={20} />
                      <RichParagraph variant="card" className="text-xs text-secondary/80">
                        400Ah Lithium, 3000W Inverter, 12V AC, 30-gal grey & 20-gal fresh water tanks.
                      </RichParagraph>
                    </div>
                    <div className="flex gap-4">
                      <Home className="text-hover shrink-0" size={20} />
                      <RichParagraph variant="card" className="text-sm text-secondary/80">
