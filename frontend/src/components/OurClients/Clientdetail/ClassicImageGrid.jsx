    ...
    return (
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 p-2 bg-secondary rounded-lg">
        <div className="grid grid-rows-2 gap-4">
          <ImageWithSkeleton src={images[0]} alt="Vermont campervan" className={`${imageStyle} h-64 md:h-80`} />
          <ImageWithSkeleton src={images[1]} alt="Vermont 2 campervan" className={`${imageStyle} h-64 md:h-80`} />
        </div>
