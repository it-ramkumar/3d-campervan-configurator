...
import { Heading1, RichParagraph, Heading3 } from '../../Common/Common'
    ...
    <section className="bbv-section-light relative py-20 md:py-28">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-20">
          ...
          <Heading1 variant="section" text="Why Should You Buy a Custom Campervan from Us?" className=" !text-primary uppercase " />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <motion.div whileHover={{ y: -5 }} className="p-10 rounded-lg bbv-card border border-hover/20 hover:border-hover/40 transition-all">
            ...
            <Heading1 variant='card' text="Ease of Travel" className=" !text-primary uppercase mb-6" />
          ...
          <motion.div whileHover={{ y: -5 }} className="p-10 rounded-lg bbv-card border border-hover/20 hover:border-hover/40 transition-all">
            ...
            <Heading1 variant='card' text="Complete Freedom" className=" !text-primary uppercase mb-6" />
            <ul className="space-y-4">
          ...
          <motion.div whileHover={{ y: -5 }} className="p-10 rounded-lg bbv-card border border-hover/20 hover:border-hover/40 transition-all">
            ...
            <Heading1 variant='card' text="Personal Comfort" className=" !text-primary uppercase mb-6" />
            <ul className="space-y-4">
          ...
          <motion.div whileHover={{ y: -5 }} className="p-10 rounded-lg bbv-card border border-hover/30 shadow-xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <Heading1 variant='card' text="Spontaneity" className=" !text-primary uppercase mb-6" />
              <ul className="space-y-4">
          ...
          <motion.div whileHover={{ y: -5 }} className="md:col-span-2 p-10 md:p-12 rounded-lg bbv-card border border-hover/30 shadow-xl relative overflow-hidden">
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div className="md:col-span-2">
                ...
                <Heading1 variant='card' text="Complete Self-Sufficiency" className=" !text-primary uppercase" />
              </div>
              <div className="">
