    ...
    <section className="bbv-section-light relative py-20">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <Heading1 variant="section" text="Adventure-ready Campervans" className=" !text-primary uppercase  mb-4" />
...
The Ultimate Moto-Base
              ...
              <Heading1 variant="section" text="The MotoVan" className=" !text-primary uppercase  mb-4" />
              <RichParagraph variant="body" className=" mb-8">
              ...
              <div className="space-y-4">
                <div className="bbv-card p-6 rounded-lg border border-hover/20">
                  <div className="flex items-center gap-3 mb-4 text-hover">
                    <Car size={24} />
                    <Heading1 variant="card" text="The Garage" className="uppercase font-bold !text-primary" />
                  </div>
                ...
                <div className="bg-hover/10 border border-hover/30 p-6 rounded-lg">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <Heading1 variant="card" text="The Living Space" className="uppercase font-bold !text-primary" />
                  </div>
