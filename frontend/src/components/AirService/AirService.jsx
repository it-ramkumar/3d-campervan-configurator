...
const AirportCard = ({
  ...
  >
    ...
    <div
      className={`absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r ${isPrivate ? "from-amber-400 to-amber-600" : "from-primary/10 to-hover/20"}`}
    ></div>
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[80vw] aspect-square max-w-[600px] border border-primary/5 rounded-full opacity-50" />
      </div>
