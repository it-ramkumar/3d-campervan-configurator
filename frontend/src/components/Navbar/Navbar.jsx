...
// import { routes } from "../../DataUseInComp/NavbarRoutes";
// import { FooterListItem } from "../Common/Li/FooterLiItem";
// import { Heading4, ImageWithSkeleton, RichParagraph } from '../Common/Common'
...
//   <Heading4 text={children} textColor="text-primary" />
// );
// // Image upar aur Title neeche wala Card component
// const NavImageCard = ({ to, src, label, contactLink = "/contact", layoutLink }) => (
...
//     {/* Buttons */}
//     <div className="flex justify-center text-xs underline gap-2 mt-2">
//       <Link
//         href={contactLink}
...
//     //   );
//     // }
//     const isGridLayout = section?.title === "Explore Layout Options"
//     // || section?.title === "Van Models Options";

//     if (isGridLayout && !isMobile) {
//       return (
//         <ul className="grid grid-cols-3 gap-4">
//           {/* Layout Categories Mapping */}
//           {section.title === "Explore Layout Options" && data?.categories?.map((cat, i) => (
//             <NavImageCard
//               key={i}
//               to={`/layout-by-category/${cat}`}
//               src="/images2/fp.png"
//               label={cat}
//               onClick={closeMobile}
//             />
...
//           {/* Wheelbase Models Mapping
//         {section.title === "Van Models Options" && data?.wheelBases?.map((base, i) => (
//           <NavImageCard
//             key={i}
//             to={`/wheel-base/${base}`}
//             src="/images2/op2.webp"
//             label={getWheelbaseLabel(base)}
//             onClick={closeMobile}
//           />
//         ))} */}
//         </ul>
...
//           {menuContent[desktopMenu]?.sections?.map((sec, idx) => {
//             const isLayout = sec.title === "Explore Layout Options" ? "col-span-3" : sec.title === "Start Your Custom Build" ? "col-span-2" : sec.title === "Company Info" ? "col-span-2" : sec.title === "Explore Layout Options" ? "col-span-3" : "col-span-1";
//             return (
//               <div
//                 key={idx}
//                 className={`${isLayout}
//                   } ${idx === 0 ? "border-r pr-10 border-primary " : ""}`}
//               >
//                 <Heading4 text={sec.title} textColor="text-primary" />
//                 <ul className="mt-4">
