...
const SeatIcon = () => (
  <div className="relative">
    <svg className="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0" viewBox="0 0 32 32" fill="none"> {/* Reduced icon size */}
      <path
        ...
        fill="url(#seatFill)"
      />
      <rect x="8" y="12" width="16" height="4" rx="1" fill="url(#seatGradient)" />
      <path
...
const PeopleIcon = () => (
  <div className="relative">
    <svg className="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0" viewBox="0 0 32 32" fill="none"> {/* Reduced icon size */}
      <circle cx="11" cy="10" r="3" stroke="url(#peopleGradient)" strokeWidth="1.5" fill="url(#peopleFill)" />
      <circle cx="21" cy="10" r="3" stroke="url(#peopleGradient)" strokeWidth="1.5" fill="url(#peopleFill)" />
      <path
...
const CargoIcon = () => (
  <div className="relative">
    <svg className="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0" viewBox="0 0 32 32" fill="none"> {/* Reduced icon size */}
      <rect x="6" y="10" width="20" height="12" rx="1" stroke="url(#cargoGradient)" strokeWidth="1.5" fill="url(#cargoFill)" />
      <path d="M6 10L11 6H21L26 10" stroke="url(#cargoGradient)" strokeWidth="1.5" />
      <rect x="10" y="13" width="3" height="3" rx="0.5" fill="url(#cargoGradient)" />
      <rect x="15" y="13" width="3" height="3" rx="0.5" fill="url(#cargoGradient)" />
      <rect x="20" y="13" width="3" height="3" rx="0.5" fill="url(#cargoGradient)" />
      <defs>
...
const MaterialIcon = () => (
  <div className="relative">
    <svg className="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0" viewBox="0 0 32 32" fill="none"> {/* Reduced icon size */}
      <rect x="8" y="8" width="16" height="16" rx="2" stroke="url(#materialGradient)" strokeWidth="1.5" fill="url(#materialFill)" />
      <path d="M12 12H20" stroke="url(#materialGradient)" strokeWidth="1.5" strokeLinecap="round" />
      <path d="M12 16H20" stroke="url(#materialGradient)" strokeWidth="1.5" strokeLinecap="round" />
      <path d="M12 20H16" stroke="url(#materialGradient)" strokeWidth="1.5" strokeLinecap="round" />
      <defs>
...
const SwivelIcon = () => (
  <div className="relative">
    <svg className="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0" viewBox="0 0 32 32" fill="none"> {/* Reduced icon size */}
      <circle cx="16" cy="16" r="6" stroke="url(#swivelGradient)" strokeWidth="1.5" fill="url(#swivelFill)" />
      <path
...
const RoofIcon = () => (
  <div className="relative">
    <svg className="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0" viewBox="0 0 32 32" fill="none"> {/* Reduced icon size */}
      <path d="M6 20L16 10L26 20" stroke="url(#roofGradient)" strokeWidth="1.5" fill="url(#roofFill)" />
      <rect x="8" y="20" width="16" height="6" rx="1" stroke="url(#roofGradient)" strokeWidth="1.5" fill="url(#roofFill)" />
      <line x1="12" y1="20" x2="12" y2="26" stroke="url(#roofGradient)" strokeWidth="1.5" />
      <line x1="20" y1="20" x2="20" y2="26" stroke="url(#roofGradient)" strokeWidth="1.5" />
      <defs>
...
const HingeIcon = () => (
  <div className="relative">
    <svg className="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0" viewBox="0 0 32 32" fill="none"> {/* Reduced icon size */}
      <rect x="8" y="8" width="16" height="16" rx="1" stroke="url(#hingeGradient)" strokeWidth="1.5" fill="url(#hingeFill)" />
      ...
      <path d="M12 8V6M20 8V6M12 26V24M20 26V24" stroke="url(#hingeGradient)" strokeWidth="1.5" strokeLinecap="round" />
      <defs>
  ...
  <div className="relative">
    <svg className="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0" viewBox="0 0 32 32" fill="none"> {/* Reduced icon size */}
      <path
        ...
        fill="url(#safetyFill)"
      />
      <path d="M12 16L15 19L20 14" stroke="url(#safetyGradient)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <defs>
...
const getIconForContent = (content) => {
  ...
  if (lowerContent.includes('comfort') || lowerContent.includes('ergonomic') || lowerContent.includes('support')) return <ComfortIcon />;
  if (lowerContent.includes('material') || lowerContent.includes('leather') || lowerContent.includes('fabric')) return <MaterialIcon />;
  if (lowerContent.includes('swivel') || lowerContent.includes('rotate') || lowerContent.includes('base')) return <SwivelIcon />;
  if (lowerContent.includes('custom') || lowerContent.includes('option') || lowerContent.includes('style')) return <CustomizationIcon />;
...
const InfoCard = ({ image, title, items, largeText = false }) => {
  ...
  return (
    ...
    >
      ...
      <div className="p-3 pt-1 sm:p-4 sm:pt-2 relative z-20"> {/* Further reduced padding */}
...
const FeatureItem = ({ text, index }) => {
    ...
    return (
      ...
      >
        ...
        <p className="text-sm md:text-base leading-relaxed flex-1 transition-all duration-300"> {/* Reduced text size to text-sm/text-base */}
          {text}
        </p>
      </div>
    );
