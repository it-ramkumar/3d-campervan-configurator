...
import { Heading2,Heading1, Heading3, Heading4, RichParagraph, SecondaryButton } from "../Common/Common";
    ...
    <div ref={containerRef} className="w-full bg-primary overflow-x-hidden">
      ...
      <section className="anim-section container mx-auto px-6 sm:px-6 pt-4 pb-8">
        <div className="text-center mb-3 md:mb-6">
          <Heading1 variant="section" text={"Decision Factors"} className="!text-secondary uppercase" />
          <div className="flex items-center justify-center gap-1.5 mt-2">
            <span className="h-px w-6 bg-white/10"></span>
            <RichParagraph variant="sub" className="!text-hover">{"Budget & Specs"}</RichParagraph>
            <span className="h-px w-6 bg-white/10"></span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-xs lg:max-w-5xl mx-auto">
          ...
          <div className="bbv-glass-light rounded-lg p-0 flex flex-col overflow-hidden hover:-translate-y-0.5 transition-transform duration-500 border-t-2 border-hover">
            <div className="p-4 md:p-3 border-b border-white/10">
              <Heading1 variant="card" text={"Cargo Van Options"} className="!text-secondary" />
              <RichParagraph variant="card" className="!text-secondary/70 !text-sm">{"The blank canvas for maximum build potential."}</RichParagraph>
            </div>
            <div className="p-4 md:p-3 flex-grow flex flex-col gap-2.5">
              <div className="group">
                <div className="flex justify-between items-baseline mb-0.5">
                  <Heading1 variant="sub" text={"Sprinter 2500 Cargo Van"} className="!text-secondary !text-base" />
                ...
                <Heading1 variant="sub" text={"Starting at $52,000"} className="!text-secondary !text-base mb-2" />
              ...
              <div className="group">
                <div className="flex justify-between items-baseline mb-0.5">
                <Heading1 variant="sub" text={"Sprinter 3500 Cargo Van"} className="!text-secondary !text-base" />
                ...
                <Heading1 variant="sub" text={"Starting at $57,000"} className="!text-secondary !text-base mb-2" />
                <ul className="text-secondary/70 text-[13px] leading-relaxed list-disc list-inside space-y-0">
          ...
          <div className="bbv-glass-light rounded-lg p-0 flex flex-col overflow-hidden hover:-translate-y-0.5 transition-transform duration-500 border-t-2 border-hover/60">
            <div className="p-4 md:p-3 border-b border-white/10">
          <Heading1 variant="card" text={"Crew Van Options"} className="!text-secondary" />
              <RichParagraph className="!text-secondary/70 !text-sm">{"Combines passenger transport with cargo utility."}</RichParagraph>
            </div>
            <div className="p-4 md:p-3 flex-grow flex flex-col gap-2.5">
              <div className="group">
                <div className="flex justify-between items-baseline mb-0.5">
                <Heading1 variant="sub" text={'Sprinter 2500 Crew Van (144" WB, High Roof)'} className="!text-secondary !text-base" />
                </div>
           <Heading1 variant="sub" text={"$60k - $70k"} className="!text-secondary !text-base mb-2" />
                <ul className="text-secondary/70 text-sm relaxed list-disc list-inside space-y-0">
              ...
              <div className="group">
                <div className="flex justify-between items-baseline mb-0.5">
             <Heading1 variant="sub" text={'Sprinter 2500 Crew Van (170" WB, High Roof)'} className="!text-secondary !text-base" />
                </div>
               <Heading1 variant="sub" text={"Starting at $61,310"} className="!text-secondary !text-base mb-2" />
                <ul className="text-secondary/70 text-[13px] leading-relaxed list-disc list-inside space-y-0">
         ...
         <Heading1 variant="card" text={"Conversion Budget"} className="!text-secondary" />
            ...
            <div className="p-4 md:p-3 flex-grow flex flex-col justify-between relative z-10">
              <div>
                <Heading1 variant="sub" text={"Plan for interior build, exterior upgrades, and custom features (e.g., $100,000 -$160,000)"} className="!text-secondary !text-base mb-2" />
      ...
      <section className="anim-section w-full relative py-8 md:py-16 text-secondary">
        ...
        <div className="container relative mx-auto px-4 sm:px-6 text-center">
          <div className="mb-4 md:mb-8">
            ...
            <Heading1 variant="section" text={"MATCHING VAN SPECS TO YOUR CONVERSION GOALS"} className="!text-secondary= uppercase" />
            <div className="bbv-divider mt-4" />
          </div>
...
{num}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-2.5 max-w-xs md:max-w-4xl mx-auto">
            ...
            <div className="group bbv-glass-light border border-white/10 rounded-md p-4 flex flex-col items-center hover:border-hover/30 transition-all duration-300">
              ...
              <Heading1 variant="card" text={"Define Your Goals"} className="!text-secondary " />
              <RichParagraph variant="sub"  className="!text-hover uppercase ">{"PURPOSE"}</RichParagraph>
              <RichParagraph variant="card" className="!text-secondary/80 mt-1">{"Identify primary use (e.g., weekend trips, full-time living, off-grid)."}</RichParagraph>
            </div>
            ...
            <div className="group bbv-glass-light border border-white/10 rounded-md p-4 flex flex-col items-center hover:border-hover/30 transition-all duration-300">
              ...
              <Heading1 variant="card" text={"Key Van Specs"} className="!text-secondary " />
              <RichParagraph variant="sub" className="!text-hover  uppercase ">{"SPECS"}</RichParagraph>
              <RichParagraph  variant="card" className="!text-secondary/80  mt-1">{"Consider size (WB), roof height, drivetrain (2WD vs. 4WD), and fuel type."}</RichParagraph>
            </div>
            ...
            <div className="group bbv-glass-light border border-white/10 rounded-md p-4 flex flex-col items-center hover:border-hover/30 transition-all duration-300">
              ...
              <Heading1 variant="card" text={"Feature Alignment"} className="!text-secondary" />
              <RichParagraph variant="sub" className="!text-hover  uppercase tracking-widest">{"MATCH NEEDS"}</RichParagraph>
              <RichParagraph variant="card" className="!text-secondary/60  mt-1">{"Match specs to needs (e.g., high roof for standing, 4WD for terrain)."}</RichParagraph>
            </div>
          </div>
        </div>
      </section>
...
Expert Guidance
          ...
          <Heading1 variant="section" text={"Consult Experts"} className="!text-secondary uppercase mb-4" />
          <RichParagraph variant="body" className="!text-secondary/70 mb-6">{"Leverage our team's experience to select the optimal van for your vision."}</RichParagraph>
