...
export default function DecisionFactors() {
 ...
 return (
  <div ref={containerRef} className="w-full bg-gray-50 font-serif text-[#1e2a4a] overflow-x-hidden">
   ...
   <section className="anim-section container mx-auto px-6 sm:px-6 pt-4 pb-8">
    <div className="text-center mb-3 md:mb-6">
     ...
     <div className="flex items-center justify-center gap-1.5 text-gray-500">
      ...
      <p className="text-[10px] uppercase tracking-widest font-semibold">Budget & Specs</p>
      <span className="h-px w-6 bg-gray-300"></span>
     </div>
    </div>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-xs lg:max-w-5xl mx-auto items-stretch">

     {/* CARD 1: CARGO VAN */}
     <div className="rounded-lg p-0 shadow-md flex flex-col overflow-hidden transition-transform duration-500 hover:-translate-y-0.5 bg-gradient-to-br from-[#1e2a4a] to-[#111827] border border-[#1e2a4a]/50">
      {/* Header */}
      ...
      <div className="p-4 md:p-3 flex-grow flex flex-col gap-2.5">
       ...
       <div className="group">
        <div className="flex justify-between items-baseline mb-0.5">
         ...
         <span className="text-[7px] font-bold px-1 py-0 bg-blue-500/20 text-blue-200 border border-blue-500/30 rounded uppercase tracking-wider">Popular</span>
        </div>
        <div className="text-sm lg:text-lg font-bold text-white mb-0.5 tracking-tight">Starting at $52,000</div>
        <ul className="text-gray-400 text-[9px] leading-relaxed list-disc list-inside space-y-0">
       ...
       <div className="group">
        <div className="flex justify-between items-baseline mb-0.5">
         ...
         <span className="text-[7px] font-bold px-1 py-0 bg-gray-700/50 text-gray-300 border border-gray-600/50 rounded uppercase tracking-wider">Heavy Duty</span>
        </div>
     ...
     <div className="rounded-lg p-0 shadow-md text-white flex flex-col overflow-hidden transition-transform duration-500 hover:-translate-y-0.5 relative bg-[#0f131a] border border-gray-800">
   ...
   <section className="anim-section w-full relative py-8 md:py-16 text-white">
    ...
    <div className="container relative mx-auto px-4 sm:px-6 text-center">
     ...
     <div className="mb-4 md:mb-8">
      ...
      <div className="w-10 h-0.5 bg-white mx-auto rounded-full opacity-50"></div>
     </div>

     {/* Number Line */}
     <div className="w-full max-w-lg mx-auto mb-6 md:mb-10 h-px bg-white/20 relative flex justify-between items-center">
      {[1, 2, 3].map((num) => (
       <div key={num} className="relative w-5 h-5 md:w-7 md:h-7 bg-[#1e2a4a] rounded-full z-10 border border-white/20 shadow-sm transform hover:scale-110 transition-transform duration-300 flex items-center justify-center">
     ...
     <div className="grid grid-cols-1 md:grid-cols-3 gap-2.5 max-w-xs md:max-w-4xl mx-auto">
      ...
      <div className="group bg-white/5 backdrop-blur-sm border border-white/10 rounded-md p-4 md:p-4 flex flex-col items-center hover:bg-white/10 transition-all duration-300">
       <div className="w-10 h-10 md:w-14 md:h-14 rounded-full bg-white/10 flex items-center justify-center mb-2 relative">
        {/* Animation Elements */}
