  ...
  return (
    ...
    <div ref={menuRef} className="fixed bottom-6 right-6 z-[9999] flex flex-col items-end gap-3">
      ...
      >
        ...
        >
          <span className="text-xs font-bold uppercase tracking-wider">Direct Call</span>
      ...
      >
        {isMenuOpen ? (
          <svg className="w-6 h-6 text-hover" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
          </svg>
        ) : (
          <svg className="w-6 h-6 transform transition-transform group-hover:scale-110" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
