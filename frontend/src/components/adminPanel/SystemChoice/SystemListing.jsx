...
export default function SystemList({ setSelected }) {
  ...
  const handleDelete = async (item) => {
    await axios.delete(`${process.env.NEXT_PUBLIC_URL}/system/${item._id}`, { withCredentials: true });
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-black text-slate-800 tracking-tight">System Choices</h2>
          <p className="text-sm text-slate-500">Manage customizable system components</p>
        </div>
