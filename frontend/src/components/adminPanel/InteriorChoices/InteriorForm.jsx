...
export default function AdminForms() {
  ...
  const fetchCategories = async () => {
    try {
      const res = await axios.get(`${process.env.NEXT_PUBLIC_URL}/interior/category`);
  ...
  const fetchSubCategories = async () => {
    try {
      const res = await axios.get(`${process.env.NEXT_PUBLIC_URL}/interior/subcategory`);
  ...
  const handleInteriorSubCategorySubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await axios.post(`${process.env.NEXT_PUBLIC_URL}/interior/subcategory`, {
