...
import { Heading2,Heading1, RichParagraph, Heading3 } from '../Common/Common'
                    ...
                    <section>
                        <div className="text-center mb-16">
                            <div className="inline-block relative">
                                <Heading1 variant='section' className="my-4" textColor="text-primary" text='Water System' />
                                <div className="mx-auto w-24 h-1 bg-hover rounded-lg"></div>
                            </div>

                            <RichParagraph ariant='body'v className="mt-6 max-w-2xl mx-auto">
                        ...
                        <div className="bg-white border border-primary/10 rounded-lg p-8 md:p-12 shadow-sm mb-10">
                            <div className="flex items-center mb-8">
                                ...
                                <Heading1 variant="card" textColor="text-primary" text="Water Pump" />
                            </div>
                        ...
                        <div className="space-y-8">
                            <div className="flex items-center justify-center">
                                {/* <Heading1 variant="card" textColor="text-primary" text="Water Tanks" /> */}
                            </div>

                            <div className="grid lg:grid-cols-2 gap-8">
                                {/* Fresh Tank */}
                                <div className="bg-primary rounded-lg p-10 shadow-xl text-secondary">
                                    <Heading1 variant="card" className="text-2xl mb-6 !text-hover">Fresh Water Tank:</Heading1>
                                    <RichParagraph variant="card" className="mb-8  text-secondary">
                                    ...
                                    <ul className="space-y-4">
                                        {[
                                            ...
                                            <li key={i} className="flex items-center bg-white/10 p-4 rounded-lg">
                                                ...
                                                <RichParagraph variant='sub' className="text-secondary">{item}</RichParagraph>
                                            </li>
                                        ))}
                                    </ul>
                                </div>
                                ...
                                <div className="bg-white border-2 border-primary rounded-lg p-10 shadow-lg">
                                    <Heading1 variant="card" className="mb-6 !text-primary">Grey Water Tank:</Heading1>
                                    ...
                                    <ul className="space-y-4">
                                        {[
                                            ...
                                            <li key={i} className="bg-secondary p-4 rounded-lg border border-primary/5">
                                                <RichParagraph variant='sub'>{item}</RichParagraph>
                                            </li>
                                        ))}
                                    </ul>
                                </div>
                        ...
                        <div className="mt-20 bg-white rounded-lg shadow-2xl overflow-hidden border border-primary/5">
                            <div className="p-10 md:p-16">
                                <div className="mb-12">
                                    <Heading1 variant="card" textColor="text-primary" text="Heaters" />
                                    <div className="w-16 h-1 bg-hover mt-2 rounded-full"></div>

                                    <RichParagraph variant="card" className="max-w-xl mt-4">
                                ...
                                <div className="grid gap-6">
                                    {[
                                        ...
                                        <div key={index} className="flex items-start bg-secondary p-6 rounded-lg">
                                            <div className="w-6 h-6 rounded-lg bg-white flex items-center justify-center mr-6 shadow-sm">
                                                <span className="text-primary font-bold">{index + 1}</span>
                                            </div>
                                            <RichParagraph variant="sub">{text}</RichParagraph>
                                        </div>
                                    ))}
                                </div>
                            </div>
