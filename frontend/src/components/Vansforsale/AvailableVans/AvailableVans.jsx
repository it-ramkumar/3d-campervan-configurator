      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row items-end justify-between gap-8 mb-12">
          <div className="max-w-2xl">
            ...
            <Heading1 variant="section" textColor="text-primary" text='In-Stock Sprinter & Ford Transit Camper Vans for Sale' />
            <div className="mt-3">
        ...
        {filteredVans && filteredVans.length > 0 ? (
                  ...
                  <div>
                    <div className="flex justify-between items-start gap-2 mb-2">
                      <Heading1 variant="card"
                        text={van?.van_listing?.title || "Custom Build"}
          ...
          <div className="mt-8">
            <div className="text-center mb-8">
              <Heading1 variant="card" text="Upcoming Builds In Progress" />
              <RichParagraph variant="card">Securing the next generation of adventure vans.</RichParagraph>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-primary p-6 flex flex-col items-center text-center justify-center shadow-xl">
                <Heading1 variant="card" text="Want a custom build?" className="text-secondary mb-2 text-lg" />
                <RichParagraph variant="card" className="text-secondary/60 text-xs mb-6 italic">Don't wait for these to finish. Secure your spot now.</RichParagraph>
