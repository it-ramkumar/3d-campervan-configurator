  ...
  const processData = [
    {
      ...
      details: [
        { subtitle: "Bring Your Van", description: (<span>Already own a Sprinter? We'll inspect it and plan your build. <CustomLink to="/van-layouts" text={"View Previous Work."}/>
       </span>) },
