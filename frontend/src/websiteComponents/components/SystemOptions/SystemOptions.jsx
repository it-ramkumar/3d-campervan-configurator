        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          ...
          <section className="mb-24">
            <div className="text-center mb-16">
              ...
              <p className="mt-8 text-xl text-gray-600 max-w-4xl mx-auto">
                The electrical system of campervans consists of batteries, shore power, an alternator, and solar panels that run your AC and other appliances. Here are the electrical components we install in your campervans:
              </p>
            </div>
            ...
            <div className="space-y-12">
                ...
                <div className="flex flex-col lg:flex-row items-start p-10 bg-gradient-to-r from-blue-50 to-gray-50">
                  ...
                  <div className="lg:w-3/5">
                    ...
                    <div className="space-y-4 text-gray-700 text-lg">
                      <p>Lithium batteries are known for their long lifespan, lightweight, fast charging, and low self-discharge rate.</p>
                      <p>At Big Bear Vans, we offer a range of battery capacities to meet customer needs. Self-heating Lithium batteries range from 200Ah to 1200Ah.</p>
                      <p><span className="font-semibold text-gray-900">Battery Monitor:</span> The battery monitor shows how much energy is left in your batteries and your current consumption.</p>
                      <p>Lithium batteries can be charged in three ways:</p>
              ...
              <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-200">
                <div className="flex flex-col lg:flex-row items-start p-10 bg-gradient-to-r from-yellow-50 to-gray-50">
                  ...
                  <div className="lg:w-3/5">
                    <h3 className="text-3xl font-bold text-gray-900 mb-6">Solar Power</h3>
              ...
              <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-200">
                <div className="flex flex-col lg:flex-row items-start p-10 bg-gradient-to-r from-purple-50 to-gray-50">
                  ...
                  <div className="lg:w-3/5">
                    <h3 className="text-3xl font-bold text-gray-900 mb-6">Shore Power</h3>
                    <div className="space-y-4 text-gray-700 text-lg">
                      <p>Shore power refers to the ability to charge batteries by connecting the camper van to an external power source. The shore power connection provides alternating current (AC), which is converted to direct current (DC) by a battery charger to charge the inverter batteries.</p>
                      <p>Typically includes a 120V or 240V connection with a built-in charger to charge the battery bank when plugged in.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-200">
                <div className="flex flex-col lg:flex-row items-start p-10 bg-gradient-to-r from-red-50 to-gray-50">
                  ...
                  <div className="lg:w-3/5">
                    <h3 className="text-3xl font-bold text-gray-900 mb-6">Inverter</h3>
                    <div className="space-y-4 text-gray-700 text-lg">
                      <p>An inverter converts direct current (DC) from batteries to alternating current (AC) to power electrical devices. At Big Bear Vans, you can choose to install a 2000W or 3000W inverter in your campervans.</p>
                      <p>The inverter drains a little bit of battery power, so it's better to turn it off when you are driving or sleeping. You've to turn it on when using a microwave or stove, or when you plug something into the 110V outlet, like an induction stove or slow cooker.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <section className="mb-24">
            <div className="text-center mb-16">
              <div className="inline-block relative">
                <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                  Electrical Appliances in Your Campervan
                </h2>
                <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-32 h-1.5 bg-gradient-to-r from-blue-600 to-green-500 rounded-full"></div>
              </div>
              <p className="mt-8 text-xl text-gray-600 max-w-4xl mx-auto">
            ...
            {/* Lighting Section */}
            <div className="mb-20">
              <h3 className="text-3xl font-bold text-gray-900 mb-10 text-center">Lighting</h3>
              ...
              <div className="grid lg:grid-cols-2 gap-10">
                ...
                <div className="bg-white rounded-3xl shadow-2xl p-10 border border-gray-200">
                  <div className="flex flex-col items-center mb-8">
                    ...
                    />
                    <h4 className="text-2xl font-bold text-gray-900">Ceiling Lights</h4>
                  </div>
                  <div className="space-y-6 text-gray-700 text-lg">
                    <p>For the lights of your ceiling, you can choose between:</p>
                    ...
                    <p>The ceiling light trims also come in different colors. You can choose to have:</p>
                ...
                <div className="bg-white rounded-3xl shadow-2xl p-10 border border-gray-200">
                  <div className="flex flex-col items-center mb-8">
                    <ImageWithSkeleton
                      ...
                      className="w-full h-80 object-cover rounded-2xl mb-8 shadow-lg"
                    />
                    <h4 className="text-2xl font-bold text-gray-900">Reading Lights</h4>
                  </div>
                  <div className="space-y-6 text-gray-700 text-lg">
                    <p>We also install 12V reading lights for the elevator and dinette bed system. These lights go directly into the batteries, so you can use them without turning on the inverter. You can choose the colour from:</p>
                    <ul className="space-y-4">
                      <li className="flex items-center bg-gray-50 p-4 rounded-xl">
                    ...
                    <p className="text-gray-600 mt-6 text-lg">These lights are extremely low power, typically drawing around 3-5W per fixture.</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-white rounded-3xl shadow-2xl p-8 border border-gray-200">
                <div className="flex flex-col items-center mb-8">
                  <ImageWithSkeleton
                    ...
                    className="w-full h-64 object-contain mb-6 rounded-xl"
                  />
                  <h4 className="text-2xl font-bold text-gray-900 text-center">Ventilation Fan</h4>
                </div>
                <p className="text-gray-700 text-lg">
              ...
              <div className="bg-white rounded-3xl shadow-2xl p-8 border border-gray-200">
                <div className="flex flex-col items-center mb-8">
                  <ImageWithSkeleton
                    ...
                    className="w-full h-64 object-contain mb-6 rounded-xl"
                  />
                  <h4 className="text-2xl font-bold text-gray-900 text-center">Air Conditioner</h4>
                </div>
                <p className="text-gray-700 text-lg">
            ...
            <div className="grid lg:grid-cols-3 gap-10">
              ...
              <div className="bg-white rounded-3xl shadow-2xl p-10 border border-gray-200">
                <div className="flex flex-col items-center mb-8">
                  ...
                  />
                  <h4 className="text-2xl font-bold text-gray-900 text-center">12V Refrigerator</h4>
                </div>
                <p className="text-gray-700 text-lg">
              ...
              <div className="bg-white rounded-3xl shadow-2xl p-10 border border-gray-200">
                <div className="flex flex-col items-center mb-8">
                  <ImageWithSkeleton
                    ...
                    className="w-full h-72 object-cover rounded-2xl mb-8"
                  />
                  <h4 className="text-2xl font-bold text-gray-900 text-center">Induction Cooktop</h4>
                </div>
                <p className="text-gray-700 text-lg">
              ...
              <div className="bg-white rounded-3xl shadow-2xl p-10 border border-gray-200">
                <div className="flex flex-col items-center mb-8">
                  <ImageWithSkeleton
                    ...
                    className="w-full h-72 object-cover rounded-2xl mb-8"
                  />
                  <h4 className="text-2xl font-bold text-gray-900 text-center">Microwave or Oven</h4>
                </div>
                <p className="text-gray-700 text-lg">
              ...
              {[
                ...
                <div key={index} className="bg-white rounded-3xl shadow-2xl p-8 border border-gray-200 hover:shadow-3xl transition-all duration-300">
                  <div className="flex flex-col items-center h-full">
                    ...
                    />
                    <h4 className="text-2xl font-bold text-gray-900 text-center mb-6">{item.title}</h4>
                    <p className="text-gray-700 text-lg text-center flex-grow">{item.desc}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <section>
            ...
            <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-200">
              <div className="flex flex-col lg:flex-row items-start p-10 bg-gradient-to-r from-orange-50 to-gray-50">
                ...
                <div className="lg:w-3/5">
                  <h3 className="text-3xl font-bold text-gray-900 mb-6">Heaters</h3>
