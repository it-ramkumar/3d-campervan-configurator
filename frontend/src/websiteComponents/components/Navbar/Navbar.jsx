...
export default function Navbar() {
  ...
  // Menu content data for mega menu
  const menuContent = {
    "vans-for-sale": {
      title: "Vans For Sale",
      sections: [
        {
          ...
          items: ["Sprinter Vans", "Ford Transit Vans", "Promaster Vans", "Volkswagen"]
        },
        {
          title: "Pre-Owned Vans",
          items: ["Ready to Ship", "In-Progress", "Previous Builds"]
        }
      ]
    },
    layouts: {
      ...
      sections: [
        {
          title: "Layout Types",
          items: ["Family-Friendly", "Solo & Couple", "Off-Grid Ready"]
        },
        {
          title: "Layout Features",
          items: ["Elevator Bed", "Full Bathroom", "Swivel Seats", "Dinette"]
        }
      ]
    },
    "3d-van-builder": {
      ...
      sections: [
        {
          ...
          items: ["Choose Van Model", "Interior Layouts", "Exterior Features", "Electrical Systems"]
        },
        {
          title: "Design Gallery",
          items: ["Popular Builds", "Customer Creations", "Inspiration", "Color Palettes"]
        }
      ]
    },
    discover: {
      ...
      sections: [
        {
          title: "Company",
          items: ["Our Story", "Team", "Testimonials", "Awards & Press"]
        },
        {
          title: "Resources",
          items: ["Blog", "FAQs", "Video Tours", "Partners"]
        }
      ]
    }
  };
  ...
  />
      ...
      <div
        ref={mobileMenuRef}
        className="md:hidden fixed top-0 left-0 w-full bg-white shadow-lg z-40 overflow-hidden"
        style={{ top: "76px", height: "0" }}
      >
