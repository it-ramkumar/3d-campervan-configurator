  ...
  return (
    <div className="bg-slate-50 text-blackish font-sans">
      ...
      <section className="relative w-full h-[250px] overflow-hidden group">
        ...
        <div className="relative z-10 flex items-center justify-center h-full p-6 text-center">
            <motion.p
              ...
              className="text-white text-xl md:text-xl font-serif font-medium max-w-4xl leading-relaxed"
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-8 py-16 md:py-24">
        ...
        >
          <motion.h2 variants={itemVariants} className="text-4xl md:text-5xl font-bold font-serif text-center mb-6 text-slate-900">
            Virtual Tours For Distant Clients
          </motion.h2>

          {/* MOVED PARAGRAPH HERE */}
          <motion.p variants={itemVariants} className="text-xl md:text-xl font-serif text-slate-700 text-center max-w-4xl mx-auto mb-16 px-4">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
            ...
            <motion.div variants={containerVariants} className="w-full md:w-5/12 lg:w-1/2 text-lg font-serif text-slate-700 space-y-6">
              ...
              {/* ORIGINAL FIRST PARAGRAPH WAS REMOVED FROM HERE */}
              ...
              <motion.div variants={containerVariants} className="space-y-4">
                ...
                <motion.div variants={itemVariants} className="group relative rounded-xl p-5 backdrop-blur-lg bg-white/60 hover:bg-white/70 border border-white/30 shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                    ...
                    <div className="flex items-center gap-x-5 pl-4">
                        ...
                        <p className="font-semibold text-slate-900">Walk through our finished builds and ongoing projects.</p>
                    </div>
                </motion.div>
                {/* Item 2 */}
                <motion.div variants={itemVariants} className="group relative rounded-xl p-5 backdrop-blur-lg bg-white/60 hover:bg-white/70 border border-white/30 shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                    ...
                    <div className="flex items-center gap-x-5 pl-4">
                        ...
                        <p className="font-semibold text-slate-900">See materials, layouts, and design options up close.</p>
                    </div>
                </motion.div>
                {/* Item 3 */}
                <motion.div variants={itemVariants} className="group relative rounded-xl p-5 backdrop-blur-lg bg-white/60 hover:bg-white/70 border border-white/30 shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                    ...
                    <div className="flex items-center gap-x-5 pl-4">
                        ...
                        <p className="font-semibold text-slate-900">Meet with our project manager, engineering, and design teams.</p>
                    </div>
                </motion.div>
              </motion.div>
