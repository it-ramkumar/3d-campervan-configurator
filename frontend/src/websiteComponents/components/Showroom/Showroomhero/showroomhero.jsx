...
const heroImage = "/heroSlider/Showroomhero.png";
...
export default function Hero() {
  ...
  return (
    ...
    <div ref={containerRef} className="relative w-full h-[60vh] md:h-[90vh] overflow-hidden">
      ...
      {/* Text Content - CHANGED to be left-aligned */}
      <div className="relative flex flex-col items-start justify-center h-full text-left px-8 md:px-16 lg:px-24">
        
        {/* Heading */}
        <h1 className="anim-content font-serif font-bold text-4xl md:text-[64px] text-white leading-tight drop-shadow-xl max-w-4xl">
          Visit Our Showroom in Big Bear, <span className="text-[#2761FD]">California</span>
        </h1>

        {/* Subheading */}
        <p className="anim-content mt-4 font-serif font-normal text-lg md:text-xl text-white opacity-90 drop-shadow-lg max-w-2xl">
          Want us to customize your van? The best way to get started is by visiting our van workshop in Big Bear City, California.
        </p>
