...
export default function Buy() {
    ...
    const buyVan = [{ "_id": { "$oid": "68f5e4fa9e2da6f634295eec" }, "slug": "santa-monica-v6-turbo", "van_listing": { "title": "Santa Monica V6 Turbo", "description": "Versatile Comfort for Unforgettable Family Adventures", "subtitle": "", "model_name": "2025", "price": { "$numberInt": "224543" }, "tagline": "", "specifications": { "make_model": "2022 Mercedes-Benz Sprinter", "wheelbase": "144", "drivetrain": "4X4", "engine": "Perferendis pariatur", "capacity": { "sits": "2", "sleeps": "5", "_id": { "$oid": "68f5e4fa9e2da6f634295eef" } }, "_id": { "$oid": "68f5e4fa9e2da6f634295eee" } }, "_id": { "$oid": "68f5e4fa9e2da6f634295eed" } }, "sold": false, "gallery": [{ "url": "https://bbv-configurator.s3.amazonaws.com/van/gallery/1760945371046_santaa.jpg", "caption": "", "_id": { "$oid": "68f5e4fa9e2da6f634295ef0" } }, { "url": "https://bbv-configurator.s3.amazonaws.com/van/gallery/1760945371169_santa1.jpg", "caption": "", "_id": { "$oid": "68f5e4fa9e2da6f634295ef1" } }, { "url": "https://bbv-configurator.s3.amazonaws.com/van/gallery/1760945371183_santa2.jpg", "caption": "", "_id": { "$oid": "68f5e4fa9e2da6f634295ef2" } }, { "url": "https://bbv-configurator.s3.amazonaws.com/van/gallery/1760945371195_santa3.jpg", "caption": "", "_id": { "$oid": "68f5e4fa9e2da6f634295ef3" } }, { "url": "https://bbv-configurator.s3.amazonaws.com/van/gallery/1760945371203_santa4.png", "caption": "", "_id": { "$oid": "68f5e4fa9e2da6f634295ef4" } }, { "url": "https://bbv-configurator.s3.amazonaws.com/van/gallery/1760945371218_santa5.jpg", "caption": "", "_id": { "$oid": "68f5e4fa9e2da6f634295ef5" } }, { "url": "https://bbv-configurator.s3.amazonaws.com/van/gallery/1760945371229_santa6.jpg", "caption": "", "_id": { "$oid": "68f5e4fa9e2da6f634295ef6" } }, { "url": "https://bbv-configurator.s3.amazonaws.com/van/gallery/1760945371239_santa7.jpg", "caption": "", "_id": { "$oid": "68f5e4fa9e2da6f634295ef7" } }], "blocks": [{ "image": null, "caption": "", "_id": { "$oid": "68f5e4fa9e2da6f634295ef8" } }], "feature_highlights": [{ "title": "no one", "description": "https://www.youtube.com/watch?v=V9bLCcBGt9g", "_id": { "$oid": "68f5e4fa9e2da6f634295ef9" } }], "detailed_features": [{ "category": "Insulation and Paneling", "items": ["4-season Thinsulate insulation", "Slatted wooden ceiling and wall panels", "Marine-style heavy-duty flooring"], "_id": { "$oid": "68f5e4fa9e2da6f634295efa" } }, { "category": "Water System", "items": ["30-gal freshwater tank", "20-gal grey water tank", "Aluminum shower with L tracks and toilet (dry-flush or separating)"], "_id": { "$oid": "68f5e4fa9e2da6f634295efb" } }, { "category": "Electrics", "items": ["1200Ah lithium batteries", "2000W inverter", "200-400W of solar panels", "30A shore power", "Combined DCDC charger and solar controller", "110V outlets with USB-C and A ports", "Advanced glycol water and air heater", "12V roof-mounted AC"], "_id": { "$oid": "68f5e4fa9e2da6f634295efc" } }, { "category": "Seating and Sleeping", "items": ["Elevator bed with expandable sides with a custom mattress", "Dinette benches transform into a full-size bed", "Double swivel seats up front that fold flat into a bed", "The 5th extra click-in seat is available"], "_id": { "$oid": "68f5e4fa9e2da6f634295efd" } }, { "category": "Kitchen", "items": ["12V 3.2 cu ft fridge and freezer", "Induction cooktop and built-in microwave", "Deep sink with an insert and drainer", "Functional drawers and a pull-out pantry", "Pop-up countertop extension", "Wall cabinets with shelves"], "_id": { "$oid": "68f5e4fa9e2da6f634295efe" } }, { "category": "Exterior", "items": ["Side ladder", "Roof deck with a foldable hammock", "Motorized awning", "Double-glazed awning-style windows with built-in blackout curtains and mosquito nets", "Flares Raptor painted with insulated inserts"], "_id": { "$oid": "68f5e4fa9e2da6f634295eff" } }], "media": ["https://www.youtube.com/watch?v=V9bLCcBGt9g"], "createdAt": { "$date": { "$numberLong": "1760945402557" } }, "updatedAt": { "$date": { "$numberLong": "1760945402557" } }, "__v": { "$numberInt": "0" } }]


    const data = readyToGoVans.length > 0 ?  readyToGoVans : buyVan
    return (
                ...
                >
                    ...
                    <div className="max-w-3xl mx-auto text-base text-gray-700 leading-relaxed text-left">
                        ...
                        >
                            <motion.li
                                variants={fadeInUp}
                                className="p-4 bg-gray-50 border-l-4 border-gray-700 rounded-r-lg transition-all duration-300 hover:shadow-md hover:bg-gray-100"
                            >
                                <div className="flex items-start gap-4">
                                    <BuildIcon />
                                    <div>
                                        <strong className="font-bold text-blackish block mb-1">Custom Build (4-5 months):</strong>
                                        <span className="text-gray-600">Total design control, 3D rendering, and engineered CAD modeling.</span>
                                    </div>
                                </div>
                            </motion.li>
                            <motion.li
                                variants={fadeInUp}
                                // ✅ CHANGED: Replaced blue with consistent dark grey for a cleaner look
                                className="p-4 bg-gray-50 border-l-4 border-gray-700 rounded-r-lg transition-all duration-300 hover:shadow-md hover:bg-gray-100"
                            >
                                <div className="flex items-start gap-4">
                                    <VanIcon />
                                    <div>
                                        ...
                                        <span className="text-gray-600">Skip the wait and drive away in a van pre-equipped with our standard luxury features: <b>sleeps 5-6</b>, <b>full amenities</b>, and <b>advanced glycol heating</b>. Just pay, sign, and drive away!</span>
                                    </div>
                                </div>
                            </motion.li>
                        </motion.ul>
