    ...
    const readyToGoVansDummy = [
        {
            ...
            video: "/videos/Big_Bear_Vans.mp4",
            id: "custom-build-3d",
        },
        {
            type: 'van',
                ...
                >
                    ...
                    >
                        {readyToGoVansDummy.map((slide, i) => (
                            <SwiperSlide
                                key={slide.id || i}
                                className="group md:!w-[900px] md:!h-[500px]"
                            >
                                {slide.type === 'custom' ? (
                                    // Render the video slide for custom builds
                                    <div className="relative w-full h-[450px] md:h-full rounded-[30px] overflow-hidden shadow-lg">
                                        <video
                                            ...
                                            muted
                                            playsInline
                                            // ✅ BRIGHTNESS CHANGE: Added `brightness-110` to slightly increase video brightness.
                                        ...
                                        <div className="relative z-10 flex flex-col justify-end items-start w-full h-full p-4 md:p-10 text-left text-white">
                                            <div className="w-full max-w-[650px] ">
                                                <h3 className="text-xl md:text-3xl   opacity-0 translate-y-5 group-hover:opacity-100 group-hover:translate-y-0
                  transition-all duration-700 ease-out font-semibold leading-tight md:leading-normal mb-2">
                                                    {slide.title}
                                                </h3>
                                                <p className="text-sm md:text-base font-normal mb-5   opacity-0 translate-y-5 group-hover:opacity-100 group-hover:translate-y-0
                  transition-all duration-700 ease-out ">{slide.desc}</p>
                                                <div className="flex gap-4">
                                                    <Link to='/inquiry'>
                                                        <button
                                                            className="bg-white cursor-pointer text-black font-serif font-bold text-xs px-3 py-1.5 md:text-sm md:px-6 md:py-2 rounded-md transform transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-lg">
                                                            Start Your Custom Build
                                                        </button>
                                                    </Link>
                                                    <Link to="/our-process">
                                                        <button
                                                            className="bg-[#2761FD] text-white cursor-pointer font-serif font-bold text-xs px-3 py-1.5 md:text-sm md:px-6 md:py-2 rounded-md transform transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-lg">
                                    ...
                                    <div className="relative w-full h-[450px] md:h-full text-white rounded-[30px] overflow-hidden shadow-lg transition-all duration-500 ease-in-out group-hover:shadow-2xl group-hover:scale-[1.03]">
                                        ...
                                        <div className="relative z-10 flex flex-col justify-between items-start w-full h-full p-4 md:p-10 text-left">
                                            ...
                                            <div className="w-full max-w-[650px]">
                                                ...
                                                <div className="flex gap-4">
                                                    <Link to='/contact'>
                                                        <button className="bg-white text-black font-serif font-bold text-sm px-4 md:px-6 py-2 rounded-md transition-all duration-300 hover:scale-105 hover:shadow-lg">
                                                            Buy Now
                                                        </button>
                                                    </Link>
                                                    <Link to="/santa-monica">
                                                        <button className="bg-[#2761FD] text-white font-serif font-bold text-sm px-4 md:px-6 py-2 rounded-md transition-all duration-300 hover:scale-105 hover:shadow-lg">
                                                            More Details
                                                        </button>
                                                    </Link>
                                                </div>
                    ...
                    {/* Navigation buttons */}
                    <div className="absolute bottom-0 right-4 md:right-8 lg:right-16 flex gap-4 mb-4 md:mb-0 z-20 translate-y-14 md:translate-y-14">
                        <button
                            onClick={() => swiperRef.current?.swiper.slidePrev()}
                            className="w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center transition-all duration-300 opacity-90 hover:opacity-100 hover:scale-110"
                        >
