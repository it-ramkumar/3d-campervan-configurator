...
const sections = [
  ...
  },
  {
    ...
    intro: (<span>While others are built for couples, ours are for the whole crew. We’re proud to have built several
      <CustomLink to={"/layout-by-category/Layouts%20for%20Families%20(3–9%20People)"} text={" family-friendly campervans "} />  In our family layouts, you can:</span>),
    features: [
  ...
  },
  {
    ...
    intro: (<span>Every Big Bear van comes with a professional-grade <CustomLink to={"/van-options/system-options"} text={"electrical and water system "} />
