...
const STEP_DATA = {
  step1: {
    ...
    duration: "Immediate",
    description: "We take the hassle out of finding the perfect base for your build. Whether you have an existing van or need a new one, we handle the logistics.",
    deliverables: ["200+ Point Inspection", "Dealership Negotiation", "Title Transfer Assistance"],
  },
  step2: {
    title: "Collaborative Design",
    image: "/sprinter/i2.png",
    duration: "1 Month",
    description: "This is where your dream takes shape. We sit down (virtually or in-person) to map out every inch of your future home on wheels.",
    deliverables: ["3D CAD Renderings", "Material Sample Kits", "Floorplan Revisions"],
  },
  step3: {
    title: "Engineering & Planning",
    image: "/sprinter/i3.png",
    duration: "2 Months",
    description: "Before a single screw is turned, our engineers ensure weight distribution, electrical load, and plumbing systems are calculated for safety.",
    deliverables: ["Electrical Schematics", "Weight Distribution Analysis", "Final Blueprint Approval"],
  },
  step4: {
    title: "Build & Assembly",
    image: "/sprinter/i4.png",
    duration: "3-4 Months",
    description: "Our master craftsmen get to work. From insulation to cabinetry, every component is hand-built and installed with automotive-grade precision.",
    deliverables: ["Weekly Photo Updates", "Sound Deadening & Insulation", "Custom Cabinetry Installation"],
  },
  step5: {
    title: "Delivery & Beyond",
    image: "/sprinter/i5.png",
    duration: "Complete",
    description: "The keys are yours. We provide a comprehensive training session so you know exactly how to operate your solar, water, and heating systems.",
    deliverables: ["System Walkthrough", "Test Drive", "1-Year Craftsmanship Warranty"],
  },
};
    ...
    const ctx = gsap.context(() => {
      ...
      rows.forEach((row) => {
        ...
        gsap.to(q(".line-fill-top"), {
          ...
          scrollTrigger: { trigger: row, start: "top 70%", end: "top 50%", scrub: 0.4 } // Tighter window
        });

        gsap.to(q(".connector-dot"), {
          backgroundColor: "#1a1f2e", borderColor: "#1a1f2e", scale: 1.2, ease: "power1.out",
          scrollTrigger: { trigger: row, start: "top 50%", toggleActions: "play reverse play reverse" } // Tighter start point
        });

        gsap.to(q(".line-fill-bottom"), {
          height: "100%", ease: "none",
          scrollTrigger: { trigger: row, start: "center 80%", end: "bottom center", scrub: 0.4 } // Tighter start point
        });
      });

      // 3. Pre-Build Section
      gsap.from(".pre-build-anim", {
        y: 40, opacity: 0, duration: 1.0, stagger: 0.1, ease: "power2.out",
  ...
  return (
    ...
    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="p-6 md:p-8 flex flex-col justify-center">
                ...
                <div className="space-y-2">
                  <h4 className="text-xs font-bold uppercase tracking-wide text-[#1a1f2e]">Key Deliverables:</h4>
      ...
      {showInquiry && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl p-8 animate-in slide-in-from-bottom-8 duration-300">
            ...
            <h3 className="text-2xl font-serif text-[#1a1f2e] mb-2">Interested in this build?</h3>
            <p className="text-gray-500 text-sm mb-6">Leave your details and our team will send you the full spec sheet for this pre-built van.</p>

            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              <div>
                <label className="block text-xs font-bold uppercase text-gray-500 mb-1">Full Name</label>
                <input type="text" className="w-full border border-gray-200 rounded-lg p-3 text-sm focus:outline-none focus:border-[#1a1f2e] transition-colors" placeholder="Jane Doe" />
              </div>
              <div>
                <label className="block text-xs font-bold uppercase text-gray-500 mb-1">Email Address</label>
                <input type="email" className="w-full border border-gray-200 rounded-lg p-3 text-sm focus:outline-none focus:border-[#1a1f2e] transition-colors" placeholder="jane@example.com" />
              </div>
      ...
      <div className="header-section flex flex-col items-center justify-center pt-20 pb-10 px-6 relative">
        ...
        <h2 className="header-anim text-center text-4xl md:text-6xl font-serif font-medium leading-[1.05] mb-6 text-[#1a1f2e] max-w-4xl tracking-tight">
          Our Custom Build Process
        </h2>

        <div className="header-anim w-[1px] h-8 bg-[#1a1f2e]/20 mb-6"></div>

        <p className="header-anim text-center text-base md:text-lg text-gray-700 font-medium max-w-[650px] leading-relaxed antialiased">
          Click on any stage below to explore the details of our craftsmanship.
        </p>
      </div>
        ...
        <div className="timeline-row grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-y-6 gap-x-0 md:gap-x-12 mb-0">
          ...
          <div className="flex flex-col items-center order-1 md:order-2 relative h-full min-h-[350px]">
            <div className="relative w-[3px] h-28">
              ...
              <div className="line-fill-top absolute top-0 left-0 w-full bg-[#1a1f2e] h-0"></div>
            </div>
        ...
        <div className="timeline-row grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-y-6 gap-x-0 md:gap-x-12 mb-0">
          <div className="fade-content flex flex-col justify-center md:text-right order-3 md:order-1 py-8">
             <div className="relative p-6 bg-gray-50 rounded-xl border-l-3 border-[#1a1f2e]">
               <h3 className="text-base font-serif font-bold mb-3 text-[#1a1f2e] leading-tight">
                 Every step is designed to tailor the van to your lifestyle
               </h3>
               <p className="text-xs text-gray-700 font-normal leading-relaxed">
                We work hand in hand with our clients to ensure that we are producing something that is according to the requirements and expectations of our clients. Our aim is to bring your imagination into reality using our expert craftsmanship, years of experience, and state-of-the-art technology.
          ...
          <div className="fade-content flex flex-col justify-center md:text-left order-2 md:order-3 py-8">
            <h3 className="text-2xl md:text-3xl font-serif text-[#1a1f2e] mb-4">Build & Assembly</h3>
            <p className="text-sm text-gray-700 font-normal leading-snug mb-3">
      ...
      <div className="pre-build-section pt-6 pb-8 px-4 sm:px-6 bg-white">
        <div className="max-w-6xl mx-auto flex flex-col items-center border-t border-gray-100 pt-6">
          ...
          <h2 className="pre-build-anim text-center text-3xl md:text-4xl font-serif text-[#1a1f2e] mb-6">
            Our Pre-Build Vans
          </h2>
