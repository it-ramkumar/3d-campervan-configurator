...
const SwivelCard = ({ title, description, animationClass, index }) => (
 <div className={`flex flex-col h-full ${animationClass} p-5 lg:p-6 bg-gradient-to-br from-[#0a0c14] to-[#151a27] rounded-xl lg:rounded-2xl shadow-xl border border-[#2a3042] hover:border-[#3a4259] transition-all duration-700 group hover:transform hover:-translate-y-2 hover:shadow-2xl relative overflow-hidden`}>
  {/* Background gradient animation */}
  <div className="absolute inset-0 bg-gradient-to-br from-[#0a0c14] via-[#151a27] to-[#0a0c14] opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
  ...
  <div className= "flex items-center mb-4 relative z-10">
   <div className="relative">
    ...
    <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-[#1e2a4a] to-[#2d3b5e] flex items-center justify-center mr-3 border border-[#3a4259] shadow-md group-hover:shadow-lg group-hover:from-[#2d3b5e] group-hover:to-[#3c4a6d] transition-all duration-500">
     <span className="font-serif font-bold text-white text-sm">{index}</span>
    </div>
    <div className="absolute -inset-0.5 rounded-lg bg-gradient-to-br from-[#4a5a8c] to-transparent opacity-0 group-hover:opacity-40 blur-sm transition-opacity duration-500"></div>
   </div>
   <div className="h-0.5 flex-1 bg-gradient-to-r from-[#3a4259] to-transparent rounded-full group-hover:from-[#4a5a8c] transition-all duration-500"></div>
  </div>

  {/* MODIFIED: Reduced lg:text-xl to lg:text-lg */}
  <h3 className="font-serif font-semibold text-base lg:text-lg text-white mb-2 group-hover:text-[#f0f4ff] transition-colors duration-500 leading-snug relative z-10">
   {title}
  </h3>
  {/* MODIFIED: Reduced text-sm to text-xs */}
  <p className="font-sans text-xs text-[#c8d0f0] leading-relaxed flex-1 relative z-10 group-hover:text-[#d8e0ff] transition-colors duration-500">
   {description}
  </p>
  ...
  <div className="mt-4 relative z-10">
   <div className="h-0.5 w-full bg-[#2a3042] rounded-full overflow-hidden">
    <div className="h-full w-0 bg-gradient-to-r from-[#4a5a8c] to-[#6a7aac] rounded-full group-hover:w-full transition-all duration-1000 ease-out"></div>
   </div>
  </div>
...
const TechCard = ({ title, description, imageUrl, animationClass }) => (
 <div className={`flex flex-col h-full ${animationClass} bg-gradient-to-b from-white to-[#fafbff] border-2 border-[#1a1f2e] rounded-xl lg:rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-700 group hover:transform hover:-translate-y-2 relative`}>
  {/* Background pattern */}
  ...
  <div className="p-4 flex-1 relative z-10">
   ...
   <h3 className="font-serif font-semibold text-base lg:text-lg text-[#0a0c14] mb-2 pb-2 border-b border-[#f0f4ff] group-hover:border-[#e0e8ff] group-hover:text-[#1a1f2e] transition-all duration-500 leading-tight">
    {title}
   </h3>
   {/* MODIFIED: Reduced text-sm to text-xs */}
   <p className="font-sans text-xs text-[#5a6578] leading-relaxed group-hover:text-[#4a5568] transition-colors duration-500">
    {description}
   </p>
  </div>
  ...
  <div className="relative mt-auto overflow-hidden">
   <div className="absolute inset-0 bg-gradient-to-t from-[#0a0c14]/60 via-[#0a0c14]/30 to-transparent z-10 group-hover:from-[#0a0c14]/40 group-hover:via-[#0a0c14]/20 transition-all duration-500"></div>
   ...
   <div className="w-full h-48 overflow-hidden">
    <ImageWithSkeleton
     ...
     onError={(e) => {
      ...
      e.target.src = "https://placehold.co/600x400/1a1f2e/FFFFFF?text=Premium+Feature";
     }}
    />
   </div>
...
export default function App() {
 ...
 return (
  ...
  <div ref={containerRef} className="relative w-full bg-white font-sans pt-10 md:pt-12 pb-4 md:pb-6 px-4 sm:px-6 lg:px-8 overflow-hidden">
   ...
   <div className="max-w-7xl mx-auto relative z-10">
    ...
    <div className="text-center mb-10">
     ...
     <div className="inline-flex items-center justify-center px-3 py-1.5 rounded-lg bg-gradient-to-r from-[#f8faff] to-[#eef2ff] border border-[#e0e8ff] shadow-md mb-4 relative overflow-hidden group">
      ...
      <span className="font-sans font-semibold text-[9px] text-[#5a6578] uppercase tracking-widest relative z-10">
       Premium Components
      </span>
     </div>

     {/* MODIFIED: Reduced lg:text-4xl to lg:text-3xl and mb-3 to mb-2 */}
     <h2 className="anim-title-main font-serif font-bold text-3xl md:text-3xl lg:text-3xl text-[#0a0c14] mb-2 leading-tight">
      Tech & Conversion
      <span className="block bg-gradient-to-r from-[#0a0c14] via-[#2d3b5e] to-[#0a0c14] bg-clip-text text-transparent mt-1">
       Ready Components
      </span>
     </h2>

     {/* MODIFIED: Reduced lg:text-xl to lg:text-lg */}
     <h3 className="anim-title-sub font-serif font-semibold text-base md:text-lg lg:text-lg text-[#6a7588] max-w-3xl mx-auto leading-relaxed">
   ...
   <div className="max-w-7xl mx-auto relative z-10">
    ...
    <div className="text-center mb-10">
     {/* MODIFIED: Reduced px-4/py-2 to px-3/py-1.5 and mb-6 to mb-4 */}
     <div className="inline-flex items-center justify-center px-3 py-1.5 rounded-lg bg-gradient-to-r from-[#0a0c14] to-[#151a27] border border-[#2a3042] shadow-md mb-4 relative overflow-hidden group">
      <div className="absolute inset-0 bg-gradient-to-r from-transparent via-[#3a4259]/30 to-transparent transform -skew-x-12 group-hover:translate-x-full transition-transform duration-1000"></div>
      <span className="font-sans font-semibold text-[9px] text-[#a8b2d0] uppercase tracking-widest relative z-10">
       Advanced Technology
      </span>
     </div>

     {/* MODIFIED: Reduced lg:text-3xl to lg:text-2xl and mb-3 to mb-2 */}
     <h3 className="anim-title-main font-serif font-bold text-xl md:text-2xl lg:text-2xl text-[#0a0c14] mb-2 leading-tight">
      Safety & Convenience
      <span className="block bg-gradient-to-r from-[#0a0c14] via-[#2d3b5e] to-[#0a0c14] bg-clip-text text-transparent mt-1">
       Technology
      </span>
     ...
     <p className="anim-title-sub font-sans text-sm text-[#6a7588] max-w-2xl mx-auto leading-relaxed">
