...
export default function ContactListing() {
  ...
  const fetchContacts = async () => {
    try {
      setLoading(true);
      const res = await axios.get(`${import.meta.env.VITE_REACT_APP_API_URL}/contact`, { withCredentials: true });
  ...
  const handleDelete = async (id) => {
    ...
    if (result.isConfirmed) {
      try {
        await axios.delete(`${import.meta.env.VITE_REACT_APP_API_URL}/contact/${id}`, { withCredentials: true });
  ...
  const handleStatusChange = async (id, newStatus) => {
    try {
      await axios.put(`${import.meta.env.VITE_REACT_APP_API_URL}/contact/${id}/status`,
