...
const Jobs = ({ setSelected }) => {
  ...
  const handleDelete = async (id, title) => {
    if (window.confirm(`Are you sure you want to delete the "${title}" position?`)) {
      try {
        await axios.delete(`${import.meta.env.VITE_REACT_APP_API_URL}/jobs/${id}`);
            ...
            >
              ...
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                ...
                <div className="flex items-center gap-3 border-t lg:border-t-0 pt-4 lg:pt-0">
                  ...
                  {/* Edit Button */}
                  <button className="bg-gray-900 text-white px-5 py-2.5 rounded-xl font-bold text-sm hover:bg-black transition-all flex items-center gap-2">
