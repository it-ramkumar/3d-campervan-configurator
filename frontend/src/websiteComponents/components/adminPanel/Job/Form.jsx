...
const JobForm = ({setSelected}) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editData && editData._id) {
        await axios.put(`${import.meta.env.VITE_REACT_APP_API_URL}/jobs/${editData._id}`, payload, { withCredentials: true });
        alert("Job Updated Successfully ✅");
        setSelected("career");

      } else {
        await axios.post(`${import.meta.env.VITE_REACT_APP_API_URL}/jobs`, payload, { withCredentials: true });
