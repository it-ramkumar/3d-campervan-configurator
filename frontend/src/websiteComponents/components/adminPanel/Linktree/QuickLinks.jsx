...
const QuickLinks = ({ setSelected }) => {
  ...
  const fetchLinks = async () => {
    try {
      ...
      const res = await axios.get(
        `${import.meta.env.VITE_REACT_APP_API_URL}/quick-links`
      );
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete this link?")) {
      try {
        await axios.delete(
          `${import.meta.env.VITE_REACT_APP_API_URL}/quick-links/${id}`
        );
  ...
  const handleDragEnd = async (result) => {
    ...
    try {
      await axios.put(
        `${import.meta.env.VITE_REACT_APP_API_URL}/quick-links/reorder`,
        {
