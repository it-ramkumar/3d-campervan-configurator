...
export default function AdminForms() {
  ...
  const fetchCategories = async () => {
    try {
      const res = await axios.get(`${import.meta.env.VITE_REACT_APP_API_URL}/system/category`);
  ...
  const fetchSubCategories = async () => {
    try {
      const res = await axios.get(`${import.meta.env.VITE_REACT_APP_API_URL}/system/subcategory`);
  ...
  const handleExteriorCategorySubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await axios.post(`${import.meta.env.VITE_REACT_APP_API_URL}/system/category`, {
  ...
  const handleInteriorSubCategorySubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await axios.post(`${import.meta.env.VITE_REACT_APP_API_URL}/system/subcategory`, {
  ...
  const handleExteriorSubmit = async (e) => {
    ...
    try {
      ...
      if (isEdit) {
        ...
        await axios.put(
          `${import.meta.env.VITE_REACT_APP_API_URL}/system/${editData._id}`,
          formData,
        ...
        await axios.post(
          `${import.meta.env.VITE_REACT_APP_API_URL}/system`,
          formData,
          { headers: { "Content-Type": "multipart/form-data" } }
        );
