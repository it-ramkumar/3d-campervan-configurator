...
import { X, Mail, Phone, Calendar, Package, ChevronRight, User } from "lucide-react";
              ...
              <div className="space-y-3">
                {user.parts.map((part) => (
                  <div key={part._id} className="group flex items-center gap-4 p-3 bg-white rounded-2xl border border-slate-100 hover:border-blue-200 transition-all shadow-sm">
                    <img src={part.imageUrl} alt={part.label} className="w-16 h-16 rounded-xl object-cover bg-slate-50" />
