    ...
    return (
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 p-2 bg-secondary rounded-lg">
        <div className="grid grid-rows-2 gap-4">
          <ImageWithSkeleton src={images[0]} alt="Vermont 1" className={`${imageStyle} h-64 md:h-80`} />
          <ImageWithSkeleton src={images[1]} alt="Vermont 2" className={`${imageStyle} h-64 md:h-80`} />
        </div>
        <div className="grid grid-cols-2 lg:grid-cols-1 lg:grid-rows-3 gap-4">
          <ImageWithSkeleton src={images[2]} alt="Vermont 3" className={`${imageStyle} h-48 md:h-52`} />
          <ImageWithSkeleton src={images[3]} alt="Vermont 4" className={`${imageStyle} h-48 md:h-52`} />
          <ImageWithSkeleton src={images[4]} alt="Vermont 5" className={`${imageStyle} h-48 md:h-52 col-span-2 lg:col-span-1 border-primary`} />
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 p-3 bg-white rounded-lg border border-primary/10">
      {images?.map((image, index) => (
        <div key={index} className={`${index === 0 ? "col-span-2 md:col-span-2 md:row-span-2" : "col-span-1"}`}>
          <ImageWithSkeleton
            src={image}
