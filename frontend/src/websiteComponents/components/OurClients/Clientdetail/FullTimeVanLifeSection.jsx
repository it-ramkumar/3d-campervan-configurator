          ...
          <div className="lg:col-span-6 bg-secondary p-8 md:p-12 rounded-lg border border-primary/10 flex flex-col justify-center">
            <div className="space-y-6 text-primary">
              ...
              <div className="flex flex-wrap gap-3 pt-4">
                ...
                <CustomLink to="/layout-detail/calabasas" text={" Calabasas "}/>
                 <CustomLink to="/layout-detail/san-diego-campervan" text={" San Diego "}/>
            ...
            <div className="lg:col-span-5 flex flex-col space-y-6">
              <div>
                ...
                <RichParagraph className="my-4">
                  We built the
                  <CustomLink to="/layout-detail/san-diego-campervan" text={" San Diego campervan "}/>
