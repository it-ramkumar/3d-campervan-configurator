            ...
            <div className="lg:col-span-7 p-6 bg-primary">
              <div className="grid grid-cols-2 grid-rows-2 gap-4 h-[400px] md:h-[500px]">
                <div className="col-span-1 row-span-2">
                  <ImageWithSkeleton src={imageData?.cusco[0]} className="w-full h-full object-cover rounded-lg border-2 border-hover" />
                </div>
                <div className="col-span-1">
                  <ImageWithSkeleton src={imageData?.cusco[1]} className="w-full h-full object-cover rounded-lg" />
                </div>
                <div className="col-span-1">
                  <ImageWithSkeleton src={imageData?.cusco[2]} className="w-full h-full object-cover rounded-lg" />
                </div>
              </div>
            </div>
          </div>
